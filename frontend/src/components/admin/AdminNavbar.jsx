      ...
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-8 shrink-0">
          ...
          <div className="hidden md:flex items-center gap-6">
            {['Dashboard', 'Users', 'Challenges', 'Reports'].map((link, i) => (
              <a
                key={link}
                href="#"
                className={`text-sm font-medium transition-colors ${
                  i === 0 ? 'text-blue-400' : 'text-gray-500 hover:text-gray-200'
                }`}
              >
                {link}
              </a>
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-md w-48">
